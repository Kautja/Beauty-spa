        ...
        <div className="flex flex-col gap-6 mt-10 text-gray-600 justify-center">
          <div className="flex items-center flex-col gap-3">
            ...
            <div className="divide-y divide-gray-300 flex flex-col gap-2 text-center">
              <a target="_blank" href="tel:+26771234567" className="text-base font-medium">+267 71 234 567</a>
            </div>
          </div>
          ...
          <div className="flex items-center flex-col gap-3">
            <Mail />
            <div className="divide-y divide-gray-300 flex flex-col gap-2 text-center">
              <a target="_blank" href="mailto:bookings@beautyspa.co.bw" className="text-base font-medium">bookings@beautyspa.co.bw</a>
            </div>
          ...
          <div className="flex items-center flex-col gap-3">
            ...
            <div className="divide-y divide-gray-300 flex flex-col gap-2 text-center lg:max-w-md">
              <span className="text-base font-medium text-center">Gaborone • Tlokweng • Phakalane</span>
              <span className="text-base font-medium text-center">Francistown • Maun • Lobatse</span>
            </div>
          </div>
        </div>
