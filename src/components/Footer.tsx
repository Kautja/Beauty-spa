      ...
      <ul className="space-y-3 text-sm text-gray-300">
        <li className="flex items-center gap-3">
          ...
          <div className='text-wrap break-all divide-y divide-gray-100/50 flex flex-col gap-2 flex-2'>
            <span>Gaborone • Tlokweng • Phakalane</span>
            <span>Francistown • Maun • Lobatse</span>
          </div>
        </li>
        <li >
          <a href="mailto:bookings@beautyspa.co.bw" className="flex items-center gap-3">
            ...
            <div className='text-wrap break-all divide-y divide-gray-100/50 flex flex-col gap-2'>
              <span>bookings@beautyspa.co.bw</span>
            </div>
          </a>
        </li>
        <li >
          <a href="tel:+26771234567" className="flex items-center gap-3">
