            ...
            <div key={service._id || index} className="bg-card border border-border rounded-[var(--radius)] p-6 group hover:shadow-lg transition-shadow">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-4">
                  ...
                  <Link href={`/services/${service._id}`} className="bg-warm-brown-800 text-primary-foreground px-6 py-3 h-auto hover:opacity-90 transition-opacity hover:bg-warm-brown-800/80 rounded-full">
                    Book Now
                  </Link>
                </div>
              </div>
